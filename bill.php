...
<html lang="en">
    ...
    <button class="btn btn-primary my-4"><a href="index.php?" class="text-light">🡰 Go to Menu </a></button>
                ...
                <div class="p-4">
                    ...
                    <div class="row">
                        ...
                        <table id="receipt_bill" class="table">
                            ...
                            <td> </td>
                            <td >
                                <h5><strong>Payment: tk</strong></h5> 
                            </td>    
                            <td>                       
                                <input type="number" id="quantity" name="quantity" style="width:25%">
                                <input type="submit">
                            </td>
                            </tr>
                            <tr>
                            <td> </td>                           
                            <td colspan="3">
                                <h5><strong>Returned Amount: tk</strong></h5>
                            </td>
                            <td class="text-center text-danger">
                                <h5 id="Payable"><strong> </strong></h5>                                    
                            </td> 
                            </tr>
                        </table>                        
                    </div>
    ...
    $('#add').on('click',function(){
        ...
        function billFunction()
            ...
            // Code for Sub Total of Vegitables 
                ...
                var Payable = parseFloat(quantity) - parseFloat(totalPayment);
